...
const ProfessionnelDetail = (): React.ReactElement => {
  ...
  // États principaux
  const [professionnel, setProfessionnel] = useState<Professionnel | null>(
    null
  );
  ...
  const handleSubmitAvis = useCallback(
      ...
      try {
        ...
        try {
          ...
          const response = await fetch(
            `${API_BASE_URL}/professionnels/${professionnel.id}`,
            {
              method: "PATCH",
              headers: {
          ...
          console.error(
            "Erreur lors de la mise à jour du professionnel:",
            error
          );
          ...
          setProfessionnel((prev) => {
            ...
            return {
              ...
              note: calculateAverageNote(
                prev.avis?.filter((a) => a.id !== newAvis.id) || []
              ),
            };
          });
      ...
      await MySwal.fire({
        ...
        html: `
          <div style="text-align: left; padding: 10px;">
            ...
            <p style="margin: 5px 0;">👨‍⚕️ Professionnel : ${
              professionnel.nom
            }</p>
    ...
    return (
      <div className="flex flex-col justify-center items-center h-64">
        ...
        <p className="text-gray-600">
          Chargement des informations du professionnel...
        </p>
      </div>
    );
  }
              ...
              <div className="mt-4 flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <span className="ml-2 text-sm text-gray-600">
                    ...
                    ({professionnel.avis?.length || 0} avis)
                  </span>
                </div>
                <button
                      ...
                      <div className="space-y-3">
                        ...
                        {professionnel.telephone && (
                          <div>
                            ...
                            <a
                              href={`tel:${professionnel.telephone}`}
                              className="text-[#015635] hover:underline"
                            >
                              {professionnel.telephone}
                            </a>
                          </div>
                        ...
                        {professionnel.email && (
                          <div>
                            ...
                            <a
                              href={`mailto:${professionnel.email}`}
                              className="text-[#015635] hover:underline"
                            >
                              {professionnel.email}
                            </a>
                            ...
                            {professionnel.formations.map(
                              (formation, index) => (
                                <li key={index} className="flex items-start">
                                  <svg
                                    className="h-5 w-5 text-[#015635] mr-2 mt-0.5 flex-shrink-0"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                  >
                    ...
                    {!showPaiementForm ? (
                      ...
                      >
                        ...
                        <p className="text-sm text-gray-600 mb-4">
                          Veuillez compléter le paiement pour confirmer votre
                          rendez-vous.
                        </p>
                        <form
                          onSubmit={
                            handlePaiementSubmit(onSubmitPaiement) as any
                          }
                          className="space-y-4"
                        >
                          <div>
                            ...
                            <div className="space-y-2">
                              <div className="flex items-center">
                                ...
                                <label
                                  htmlFor="wave"
                                  className="ml-2 block text-gray-700 flex items-center"
                                >
                                  <img
