...
import { PencilIcon, LockClosedIcon, ArrowRightOnRectangleIcon } from "@heroicons/react/24/solid";
      ...
      <div className="min-h-screen bg-gradient-to-r from-gray-50 to-white px-4 py-10 flex items-center justify-center">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-10">
          ...
          <div className="flex flex-col items-center md:w-1/3">
            ...
            />
            <h2 className="mt-4 text-2xl font-semibold text-gray-800">{user.nom}</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-3 gap-x-6">
              ...
              <div>
                ...
                <p className="text-base font-medium text-gray-900">
                  {(user as any).dateInscription
                    ? new Date((user as any).dateInscription).toLocaleDateString("fr-FR")
                    : "Non disponible"}
                </p>
              </div>
              <div>
                ...
                >
                  {(user as any).actif ? "Actif" : "Inactif"}
                </span>
              </div>
            </div>
