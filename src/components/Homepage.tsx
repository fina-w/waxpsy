...
const Homepage: React.FC = () => {
  ...
  switch (window.location.pathname) {
    ...
    default:
      return (
        <div className="min-h-screen flex flex-col bg-gradient-to-r from-white via-white to-blue-100">
          {/* Hero Section */}
          <section
          ...
          <section className="flex flex-col justify-center items-center md:flex-row bg-gradient-to-r from-white via-white to-blue-100 px-6 py-12 space-y-8 md:space-y-0 md:space-x-12">
            ...
            <div className="max-w-xl">
              ...
              <p className="text-lg leading-relaxed">
                ...
                pour démystifier ces troubles dans un contexte culturel
                africain, mais surtout sénégalais.
              </p>
            </div>
          </section>
            ...
            <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20">
              <div className=" rounded-3xl p-8 border-2 border-black shadow-lg text-center">
                ...
                <p className="text-gray-700 text-base leading-relaxed mb-6">
                  Vous souhaitez parler à un psychologue ou psychiatre ? Trouvez
                  un spécialiste près de vous
                </p>
                <button
              ...
              <div className=" rounded-3xl p-8 border-4 border-red-500 shadow-lg text-center">
                ...
                <p className="text-gray-700 text-base leading-relaxed mb-6">
                  Vous êtes en détresse ou avez besoin d'aide immédiate ?
                  Accédez aux numéros d'urgence 24h/24.
                </p>
                <button
